...
M.defaults = {
  ...
  mpl_interactive  = { mode = "n",          lhs = "<leader>nz", desc = "Toggle interactive plot (zoom/pan)" },
...
local actions = {
  ...
  mpl_interactive  = function(buf, _api) return function() require("jupynvim.notebook.mpl").toggle(buf) end end,
